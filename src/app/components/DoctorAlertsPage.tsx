...
interface DoctorAlertsPageProps {
...
export function DoctorAlertsPage({ onNavigate }: DoctorAlertsPageProps) {
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">Monitor and manage patient health notifications</p>
        </div>
              ...
              <tbody>
                {alerts.map((alert) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 font-semibold">{alert.patient}</td>
